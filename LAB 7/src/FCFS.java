...
public class FCFS {
    public static void main(String[] args) {
        ...
        while(completedProcesses < n) {
            ...
            // If there is such process, calculate the waiting time and turn around time of the process, update the current time, mark the process as completed, and increment the number of completed processes
            else {
