    ...
    public static void main(String[] args) {
        ...
        while (!readyQueue.isEmpty()) {
            ...
            if (processes.get(i)[2] <= quantum) {
                ...
                processes.get(i)[2] = 0; // Remaining Burst
                processes.get(i)[3] = time; // Exit
                processes.get(i)[4] = processes.get(i)[3] - processes.get(i)[0]; // Turnaround = Exit - Arrival
                processes.get(i)[5] = processes.get(i)[4] - processes.get(i)[1]; // Wait = Turnaround - Burst
            }
