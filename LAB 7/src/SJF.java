...
public class SJF {
    public static void main(String[] args) {
        ...
        while(completedProcesses < n) {
            ...
            // If there is such a process, Calculate the waiting time and turn around time of the process, Udate the current time, Mark the process as completed & Increment the number of completed processes
            else {
